...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.radius = x < y ? x:y;
        self.value = 1;
        self.startColor = [UIColor colorWithRed:1.0 green:0.8 blue:0.0 alpha:1.0];
        self.backgroundColor = [UIColor clearColor];
        self.boundsColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:0.15];
        self.opaque = NO;
    }
    return self;
}
...
-(id) initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.radius = x < y ? x:y;
        self.value = 1;
        self.startColor = [UIColor colorWithRed:1.0 green:0.843 blue:0.0 alpha:1.0];
        self.backgroundColor = [UIColor clearColor];
        self.boundsColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:0.15];
